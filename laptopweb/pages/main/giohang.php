                ...
                <tr>
                    <td colspan="9">
                        ...
                        <button style="float: right;" type="button" class="btn btn-danger"><a href="pages/main/themgiohang.php?xoatatca=1">Xóa tất cả</a>
                            ...
                            if (isset($_SESSION['dangky'])) {
                            ?>
                                <button style="float: left; margin-left: 10px" type="button" class="btn btn-primary"><a class="text-white text-decoration-none" href="index.php?quanly=thanhtoan">Đặt hàng</a></button>
                            <?php
                            } else {
                            ?>
